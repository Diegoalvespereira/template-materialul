        ...
        <CardContent>
          <TableContainer component={Paper}>
            <Table sx={{ minWidth: 650 }} size="small" aria-label="a dense table">
              <TableHead>
                <TableRow style={{ backgroundColor: '#f5f5f5' }}> {/* Estilo de background color adicionado */}
                  <TableCell>#</TableCell>
              ...
              <TableBody>
                {tarefas.map((row, indice) => (
                  <TableRow
                    ...
                    style={{ cursor: 'pointer' }} // Adiciona o estilo cursor pointer
                    hover // Adiciona o estilo hover nas linhas
                  >
